...
class BruteForceTest {
	...
	public void testCasesInFile() throws IOException {
		...
		for(int i = 0; i < 10; i++) {
			...
			// Runs the brute force max subarray algorithm.
			int[] actual = tester.findMaxSubarray(testCase);
			
			// Tests that brute force algorithm performs correctly.
	...
	public void testRunningTimeSize100() {
		// Tests running time of brute force with an array size of 100.
		
		// Uses helper class to generate a random array with size 100.
		randomGen = new RandomArray(100);
		
		// Generates 10 different random arrays.
		// Calculates brute force algorithm running times to find max subarray
		// and prints out the average time.
		for(int i = 0; i < 10; i++) {
	...
	public void testRunningTimeSize200() {
		// Tests running time of brute force with an array size of 200.
	...
	public void testRunningTimeSize500() {
		// Tests running time of brute force with an array size of 500.
	...
	public void testRunningTimeSize1000() {
		// Tests running time of brute force with an array size of 1000.
	...
	public void testRunningTimeSize2000() {
		// Tests running time of brute force with an array size of 2000.
	...
	public void testRunningTimeSize5000() {
		// Tests running time of brute force with an array size of 5000.
	...
	public void testRunningTimeSize10000() {
		// Tests running time of brute force with an array size of 10000.
