...
class DivideAndConquerTest {
	...
	@BeforeEach
	void setUp() {
		tester = new DivideAndConquer(new int[0]);
	...
	public void testCasesInFile() throws IOException {
		...
		for(int i = 0; i < 10; i++) {
			...
			tester = new DivideAndConquer(testCase);
			int[] actual = tester.findMaxSubarray(0, testCase.length - 1);
			
			// Tests that Divide and Conquer Algorithm performs correctly.
	...
	public void testSmallCase1() {
		...
		tester = new DivideAndConquer(array);
		expectedMax = 7;
		expectedArrive = 2;
		expectedDepart = 6;
		int[] actual = tester.findMaxSubarray(0, array.length - 1);
		assertEquals(expectedMax, actual[0]);
		assertEquals(expectedArrive, actual[1]);
		assertEquals(expectedDepart, actual[2]);	
	}
	...
	public void testRunningTimeSize100() {
		// Tests running time of Divide and Conquer algorithm with an array size of 100.
		
		// Uses helper class to generate a random array with size 100.
		randomGen = new RandomArray(100);
		
		double sum = 0;
		// Runs 10 different random arrays and Divide and Conquer algorithm running time
		// and prints out the average time it takes to find max subarray.
		for(int i = 0; i < 10; i++) {
			int[] array = randomGen.generateRandomArray();
			tester = new DivideAndConquer(array);
			time = System.nanoTime();
			tester.findMaxSubarray(0, array.length - 1);
	...
	public void testRunningTimeSize200() {
		// Tests running time of Divide and Conquer algorithm with an array size of 200.
	...
	public void testRunningTimeSize500() {
		// Tests running time of Divide and Conquer algorithm with an array size of 500.
	...
	public void testRunningTimeSize1000() {
		// Tests running time of Divide and Conquer algorithm with an array size of 1000.
	...
	public void testRunningTimeSize2000() {
		// Tests running time of Divide and Conquer algorithm with an array size of 2000.
	...
	public void testRunningTimeSize5000() {
		// Tests running time of Divide and Conquer algorithm with an array size of 5000.
	...
	public void testRunningTimeSize10000() {
		// Tests running time of Divide and Conquer algorithm with an array size of 10000.
